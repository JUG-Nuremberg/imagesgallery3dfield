 ...
 * @since  3.7.0
 */
class PlgFieldsImagesgallery3dfield extends FieldsListPlugin
{
	/**
	...
	public function onCustomFieldsPrepareDom($field, DOMElement $parent, JForm $form)
	{
		...
		$fieldNode->setAttribute('label', 'PLG_FIELDS_IMAGESGALLERY3DFIELD_PARAMS_DIRECTORY_LABEL');
		$fieldNode->setAttribute('description', 'PLG_FIELDS_IMAGESGALLERY3DFIELD_PARAMS_DIRECTORY_DESC');
